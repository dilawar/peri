# -*- coding: utf-8 -*-
#
# PERI documentation build configuration file, created by
...
try:
    release = pkg_resources.get_distribution('peri').version
except pkg_resources.DistributionNotFound:
    warnings.Warn(
        "Distribution information for `peri` must be available. Either install"
        "the package or setup the correct paths to enable package reading."
    )
    sys.exit(1)
del pkg_resources

version = re.findall(r'([0-9\.]*).*', release)[0]
release = release
